...
class BrainRouter {
    ...
    _applyContextBoost(signals, context, overrideBoost = null) {
        ...
        // LG-03: historical-route bias is a known route-flipping input (RC-04);
        // make every application of it visible for misroute forensics.
        logger.info('CONTEXT_BOOST', `Applying historical route bias`, {
            lastRoute: last,
            boost: contextBoost
        });
